...
(function() {
  var answerQuestion, commands, scrollTo;

  window.initSelect2 = function() {
    return $("#question_tags").select2({
      width: 400
    });
  };
  ...
  $(function() {
    $("#save_question").click(function(e) {
      e.preventDefault();
      return $("#question_submit").trigger("click");
    });
    $("#create_question_button").click(function(e) {
      e.preventDefault();
      return window.initSelect2();
    });
    return window.initSelect2();
  });
  ...
  scrollTo = function(identifier, speed) {
    $("html, body").animate({
